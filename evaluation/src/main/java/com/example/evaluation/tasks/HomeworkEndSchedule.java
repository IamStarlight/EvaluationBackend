...
//@EnableScheduling
//@EnableAsync
public class HomeworkEndSchedule implements SchedulingConfigurer {
    private Integer wid;
    ...
    public HomeworkEndSchedule(Integer wid, Integer cid){
        this.wid = wid;
        this.cid = cid;
    }
...
//                () -> task(),
    ...
    private void task(){
        //将作业状态改为截止
        workService.statusToEnd(wid,cid);
        // TODO: 2023-11-22 发送作业截止消息
    }
}
